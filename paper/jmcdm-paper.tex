...
COPRAS (COmplex PRoportional ASsessment)\cite{topsis}, 
COCOSO (Combined Compromise Solution)\cite{topsis}, 
and CRITIC (CRiteria Importance Through Intercriteria Correlation)\cite{topsis} for multiple-criteria tools. The package also performs DEA for Data Envelopment Analysis\cite{topsis} and includes a method for zero-sum game solver.  
