...
DEMATEL (The Decision Making Trial and Evaluation Laboratory)\cite{demateş}, 
...
and CRITIC (CRiteria Importance Through Intercriteria Correlation)\cite{critic} for multiple-criteria tools. 
