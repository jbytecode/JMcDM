...
The package implements methods for TOPSIS (Technique for Order Preference by Similarity to Ideal Solutions)\cite{topsis}, ELECTRE (Elemination and Choice Translating Reality)\cite{Citation_Comes_Here}, PROMETHEE (Preference Ranking Organization METHod for Enrichment of Evaluations)\cite{Citation_Comes_Here}, DEMATEL (The Decision Making Trial and Evaluation Laboratory)\cite{Citation_Comes_Here}, MOORA (Multi-Objective Optimization By Ratio Analysis)\cite{Citation_Comes_Here}, VIKOR (VlseKriterijumska Optimizcija I Kaompromisno Resenje in Serbian)\cite{Citation_Comes_Here}, AHP (Analytic Hierarchy Process)\cite{Citation_Comes_Here}, GRA (Grey Relational Analysis)\cite{Citation_Comes_Here}, NDS (Non-dominated Sorting)\cite{Citation_Comes_Here}, SAW (Simple Additive Weighting)\cite{Citation_Comes_Here}, ARAS (Additive Ratio Assessment)\cite{Citation_Comes_Here}, WPM (Weighted Product Model)\cite{Citation_Comes_Here}, WASPAS (Weighted Aggregated Sum Product ASsessment)\cite{Citation_Comes_Here}, EDAS (Evaluation based on Distance from Average Solution)\cite{Citation_Comes_Here}, MARCOS (Measurement Alternatives and Ranking according to COmpromise Solution)\cite{Citation_Comes_Here}, MABAC (Multi-Attributive Border Approximation area Comparison)\cite{Citation_Comes_Here}, MAIRCA (Multi Attributive Ideal-Real Comparative Analysis)\cite{Citation_Comes_Here}, COPRAS (COmplex PRoportional ASsessment)\cite{Citation_Comes_Here}, COCOSO (Combined Compromise Solution)\cite{Citation_Comes_Here}, and CRITIC (CRiteria Importance Through Intercriteria Correlation)\cite{Citation_Comes_Here} for multiple-criteria tools. The package also performs DEA for Data Envelopment Analysis\cite{Citation_Comes_Here} and includes a method for zero-sum game solver.  
